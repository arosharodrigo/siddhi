...
public class GpuJoinQuerySelectorWorker extends GpuQuerySelectorWorker {
    ...
    public GpuJoinQuerySelectorWorker(StreamEventPool streamEventPool, StreamEventConverter streamEventConverter,
            List<AttributeProcessor> attributeProcessorList) {
        super(streamEventPool, streamEventConverter, attributeProcessorList);
